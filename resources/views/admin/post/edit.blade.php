      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="{{route('post.update',$post->id)}}" enctype="multipart/form-data" method="POST">
              {{csrf_field()}}
              {{method_field('PUT')}}
              <div class="box-body">
                <div class="col-md-6"> 
               ...
               <div class="form-group">
                 ...
                 <input type="text" name="subtitle" class="form-control" id="sub-title" value=" {{$post->subtitle}} " placeholder="Sub title">
               </div>
                ...
                <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select a State" style="width: 100%;" tabindex="-1" aria-hidden="true" name="categories[]">
                  @foreach($categories as $category)
                    <option value="{{$category->id}}"
                      ...
                      @if($postCategory->id == $postCategory->id)
                        {{'selected'}}
                      @endif
