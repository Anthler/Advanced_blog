          ...
          <div class="box box-primary">
            ...
            <form action=" {{route('user.store')}} " method="post" role="form">
              ...
              <div class="box-body">
               ...
               <div class="form-group">
                 ...
                 <input type="text" name="phone" class="form-control" id="phone" placeholder="Enter phone number..." value="{{ old('phone') }}">
                  ...
                  <div class="checkbox">
                    <label ><input name="status" type="checkbox" @if(old('status')==1)  checked @endif value="1">Status</label>
                  </div>
                </div>
              ...
              @foreach($roles as $role)
                <div class="col-lg-3">
                  <div class="checkbox">
                    <label for=""><input name="role[]" type="checkbox" value=" {{$role->id}} "> {{$role->name}}</label>
                  </div>   
                </div>
              @endforeach
                </div>
