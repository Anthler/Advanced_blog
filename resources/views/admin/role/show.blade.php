    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href=" {{route('role.create')}} " class="btn btn-success btn-lg col-lg-offset-5">Add New</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href=" {{route('role.edit',$role->id)}} "><span class="fa fa-edit" style="font-size:20px"></span></a></td>
                  <td>
